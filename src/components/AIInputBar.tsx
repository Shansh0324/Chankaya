    ...
    <div className="w-full max-w-4xl mx-auto p-4">
      <div className="relative">
        ...
        <div className="flex items-end gap-3 p-3 bg-[#FCFAF8] backdrop-blur-sm rounded-3xl border border-gray-300/50 shadow-lg">
          ...
          >
            {hasUploadedMedia ? (
              // Send arrow for mixed media
              <svg 
                className={`w-5 h-5 text-white transition-transform duration-200 ${canSend ? 'group-hover:scale-110' : ''}`} 
                fill="currentColor" 
                viewBox="0 0 24 24"
              >
              ...
              // Paper airplane for text only
              <svg 
                className={`w-5 h-5 text-white transition-transform duration-200 ${canSend ? 'group-hover:scale-110 group-hover:translate-x-0.5' : ''}`} 
                fill="currentColor" 
                viewBox="0 0 24 24"
              >
                <path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/>
